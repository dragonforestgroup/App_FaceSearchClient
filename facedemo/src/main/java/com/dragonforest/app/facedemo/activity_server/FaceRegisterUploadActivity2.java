 ...
 * 人脸注册 上传特征码
 */
public class FaceRegisterUploadActivity2 extends AppCompatActivity implements ViewTreeObserver.OnGlobalLayoutListener {
            ...
            if (registerDialog == null) {
                ...
                registerDialog.setOnRegisterListener(new RegisterDialog.OnRegisterListener() {
                    ...
                    public void onRegister(String name, String sex, int groupId) {
                        ...
                        currentName = name;
                        Toast.makeText(FaceRegisterUploadActivity2.this, "设置完成", Toast.LENGTH_SHORT).show();
                    }
                });
            }
            registerDialog.show();
    ...
    private void initCamera() {
        final FaceListener faceListener = new FaceListener() {
            ...
            public void onFaceFeatureInfoGet(@Nullable final FaceFeature faceFeature, final Integer requestId) {
                ...
                if (faceFeature != null) {
                    registerFace(faceFeature.getFeatureData());
                }
            }
        ...
        CameraListener cameraListener = new CameraListener() {
            ...
            public void onCameraOpened(Camera camera, int cameraId, int displayOrientation, boolean isMirror) {
                ...
                faceHelper = new FaceHelper.Builder()
                        ...
                        .currentTrackId(ConfigUtil.getTrackId(FaceRegisterUploadActivity2.this.getApplicationContext()))
                        .build();
            }
    ...
    private void registerFace(final byte[] feature) {
        if (registerStatus == REGISTER_STATUS_READY) {
            ...
            Observable.create(new ObservableOnSubscribe<Boolean>() {
                ...
                public void subscribe(ObservableEmitter<Boolean> emitter) {
                    ...
                    if (feature != null) {
                        boolean isRegisted = ArcHttpUtil.getInstance().registerFaceByFeature(feature, currentName, personInfo.getGroupId(), 1, 1);
                        if (!isRegisted) {
                        ...
                        emitter.onError(new Exception("图像中无人脸信息"));
                    }
                    ...
                    .subscribe(new Observer<Boolean>() {
                        ...
                        public void onNext(Boolean success) {
                            ...
                            Toast.makeText(FaceRegisterUploadActivity2.this, result, Toast.LENGTH_SHORT).show();
                            registerStatus = REGISTER_STATUS_DONE;
                        }

                        @Override
                        public void onError(Throwable e) {
                            Toast.makeText(FaceRegisterUploadActivity2.this, "register failed!" + e.getMessage(), Toast.LENGTH_SHORT).show();
                            registerStatus = REGISTER_STATUS_DONE;
                        }
