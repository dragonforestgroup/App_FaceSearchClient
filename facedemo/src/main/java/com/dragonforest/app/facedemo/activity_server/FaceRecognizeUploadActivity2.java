 ...
 * 人脸识别 上传特征码
 */
public class FaceRecognizeUploadActivity2 extends AppCompatActivity implements ViewTreeObserver.OnGlobalLayoutListener {
        ...
        CameraListener cameraListener = new CameraListener() {
            ...
            public void onCameraOpened(Camera camera, int cameraId, int displayOrientation, boolean isMirror) {
                ...
                faceHelper = new FaceHelper.Builder()
                        ...
                        .currentTrackId(ConfigUtil.getTrackId(FaceRecognizeUploadActivity2.this.getApplicationContext()))
                        .build();
            }
        ...
        if (recognizeStatus == RECOGNIZE_STATUS_READY) {
            ...
            Observable.create(new ObservableOnSubscribe<String>() {
                ...
                public void subscribe(ObservableEmitter<String> emitter) {
                    if (feature != null) {
                        com.dragonforest.app.facedemo.model.CompareResult result = ArcHttpUtil.getInstance().searchFaceByFeature(feature, 2);
                    ...
                    .subscribe(new Observer<String>() {
                        ...
                        public void onNext(String msg) {
                            Toast.makeText(FaceRecognizeUploadActivity2.this, msg, Toast.LENGTH_SHORT).show();
                            recognizeStatus = RECOGNIZE_STATUS_DONE;
                        }

                        @Override
                        public void onError(Throwable e) {
                            Toast.makeText(FaceRecognizeUploadActivity2.this, "识别失败：" + e.getMessage(), Toast.LENGTH_SHORT).show();
                            recognizeStatus = RECOGNIZE_STATUS_DONE;
                        }
